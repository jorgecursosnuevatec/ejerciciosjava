package com.jgr.ejercicios.prog.funcional.inline.servicio;
 ...
 */
public class SuperFuncionesInline {
	 ...
	 * @return the list
	 */
	public static List<Integer> filtrar(List<Integer> lista, PredicadoInline predicado){
	 ...
	 * @return the list
	 */
	public static List<Integer> proveer(int cuantos,ProveedorInline proveedor){
	 ...
	 * @return the list
	 */
	public static List<Integer> transformar(List<Integer> lista,FuncionInline funcion){
	 ...
	 * @return the list
	 */
	public static List<Integer> actuarSobreLista(List<Integer> lista,ConsumidorInline consumidor){
	 ...
	 * @return the list
	 */
	public static void consumirLista(List<Integer> lista,ConsumidorInline consumidor){
	 ...
	 * @return the integer
	 */
	public static Integer reduciryAcumular(List<Integer> lista,Integer acumulador ,FuncionBinariaInline funcionBinaria) {
