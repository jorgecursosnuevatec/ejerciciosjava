...
/**
 * The Class LanzadoraEjemploFrutas.
 * https://jarroba.com/annotations-anotaciones-en-java/
 * 
 */
public class LanzadoraEjemploFrutas {
	 ...
	 *
	 * @param bolsita            objeto de la clase Bolsita del que extraer las calorías de únicamente los FrutosSecos
