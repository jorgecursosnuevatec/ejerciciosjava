 ...
 * usamos un executors pero creando solo un hilo,una espera a la otra
 */
public class ExecutorFixedPoolThread {

	public static void main(String[] args) throws InterruptedException, ExecutionException {

		// ThreadPoolExecutor executor = (ThreadPoolExecutor)
		// Executors.newFixedThreadPool(3); // se crea un pool de 3
		// System.out.println("Tamaño del pool: " + executor.getPoolSize());
		// System.out.println("Cantidad de tareas en cola: " +
		// executor.getQueue().size());
		ExecutorService executor = Executors.newSingleThreadExecutor();

		Callable<String> tarea = () -> {
			System.out.println("Inicio de la tarea..." + Thread.currentThread().getName());
			try {
		...
		while (!(resultado.isDone() && resultado2.isDone() && resultado3.isDone())) {
			System.out.println(String.format("resultado1: %s - resultado2: %s - resultado3: %s",
					resultado.isDone() ? "finalizó" : "en proceso", resultado2.isDone() ? "finalizó" : "en proceso",
