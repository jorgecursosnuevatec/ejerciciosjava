...
public class JavaLocalDate {
	...
	public static void main(String[] args) {
		...
		if(f1.isBefore(f2)) {
			...
			System.out.println("\nLa fecha más reciente es: "+f2);
		}else {
			System.out.println("La fecha más antigua es: "+f2);
			System.out.println("\nLa fecha más reciente es: "+f1);
		}
		//operamos con la fecha
		...
		System.out.println("\nnuevaFecha parse->"+nuevaFecha);

		// formateamos fecha
		DateTimeFormatter format2 = DateTimeFormatter.ofPattern("yy-MM-dd");
		LocalDate date = LocalDate.now();
		System.out.println("\nA partir de una LocalDate yy-MM-dd->" + date.format(format2));
		...
		format2=DateTimeFormatter.ofPattern("dd/MM/yyyy");
		LocalDate date2=LocalDate.of(2022,10,20);
		//System.out.println(date2.format(format2)); //20/10/202

		f1=LocalDate.of(2019, 10, 30);
		f2=LocalDate.of(2016, 01, 31);
		//comparación fechas
		if(f1.isBefore(f2)) {
			System.out.println("La fecha más antigua es: "+f1);
		...
		format1=DateTimeFormatter.ofPattern("dd/MM/yyyy");
		...
		mf="11/11/2018";
		nuevaFecha = LocalDate.parse(mf,format1);
		...
		ld1 = LocalDate.now();
		ld2 =LocalDate.of(2021, 7,22);
		t1=LocalTime.of(10,23,50); //10:23:50
		dt=LocalDateTime.of(2010,11,1,10,23,50); //2010-11-01T10:23:5
		System.out.println("resultadoComparacion->"+ld1.isAfter(ld2));
